module.exports = {
    ...
    meta: { version: "2.1.6", preciseCheck: true, author: 'Gotowka', authorUrl: 'https://github.com/Gotowka/dbmmody/blob/main/beta/gend.js', downloadUrl: 'https://github.com/Gotowka/dbmmody/blob/main/beta/gend.js' },
            ...
            for (i = 0; i < giveaways[giveawayid].length; i++) {
                if (new Date().getTime() > giveaways[giveawayid][i].end && giveaways[giveawayid][i].ended == false) {
                    ...
                    const button = new MessageActionRow().addComponents(
                        ...
                        .setStyle('DANGER')
                        .setDisabled(true)
                        .setLabel(`Udział brało ${users} użytkowników`)
                    )
